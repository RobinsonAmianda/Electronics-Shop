...
import styles from "./NavbarElectronicsDesktop1.module.css";

export type NavbarElectronicsDesktop1Type = {
  className?: string;
};

const NavbarElectronicsDesktop1: FunctionComponent<
  NavbarElectronicsDesktop1Type
> = ({ className = "" }) => {
  const [
          ...
          <div className={styles.search}>
            ...
            <div className={styles.sale}>
              <div className={styles.secondaryButton}>
                <img className={styles.icon2} alt="" src="/icon-16.svg" />
              </div>
            ...
            <div className={styles.buttons}>
              ...
              <div className={styles.secondaryButton2}>
                <img className={styles.icon4} alt="" src="/icon-3.svg" />
              </div>
              <div className={styles.secondaryButton3}>
                <img className={styles.icon5} alt="" src="/icon-4.svg" />
              </div>
              <div className={styles.cart}>
                <div className={styles.secondaryButton4}>
                  <img className={styles.icon6} alt="" src="/icon-5.svg" />
                </div>
...
export default NavbarElectronicsDesktop1;
