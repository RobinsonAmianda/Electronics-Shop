...
import styles from "./FooterElectronicsDektop1.module.css";

export type FooterElectronicsDektop1Type = {
  className?: string;
};

const FooterElectronicsDektop1: FunctionComponent<
  FooterElectronicsDektop1Type
> = ({ className = "" }) => {
  return (
      ...
      <div className={styles.top}>
        ...
        <div className={styles.menu}>
          ...
          <div className={styles.links}>
            ...
            <a className={styles.txt4}>News</a>
          </div>
        </div>
...
export default FooterElectronicsDektop1;
